        ...
        <div class="container">
            <div class="row">
                <div class="page-header">
                  <h1>Registro de usuarios <small class="tittles-pages-logo">La Tiendita</small></h1>
                </div>
                <div class="col-xs-12 col-sm-6 text-center">
                   <br><br><br>
                    <p><i class="fa fa-users fa-5x"></i></p>
                    <p class="lead">
                        Al registrarse podra reservar productos desde nuestra plataforma.
                    </p>
                    <br>
                    <!--<img src="assets/img/" class="img-responsive"> IMAGEN PARA REGISTRO-->
                </div>
