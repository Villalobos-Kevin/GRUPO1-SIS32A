...
<nav id="navbar-auto-hidden">
        <div class="row hidden-xs"><!-- Menu responsive -->
            <div class="col-xs-4">
                
                <p class="text-navbar tittles-pages-logo">La Tiendita</p>
            </div>
            <div class="col-xs-8">
      ...
      <div class="modal-dialog modal-sm">
          <div class="modal-content" id="modal-form-login">
                <div class="modal-header">
                  ...
                  <h4 class="modal-title text-center text-primary" id="myModalLabel">Iniciar sesión en La Tiendita</h4>
                </div>
            <form action="process/login.php" method="post" role="form" style="margin: 20px;" class="FormloginLT" data-form="login">
    ...
    <div id="mobile-menu-list" class="hidden-sm hidden-md hidden-lg">
        <br>
        <h3 class="text-center tittles-pages-logo">La Tiendita</h3>
