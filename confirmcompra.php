...
if($num>0){
  ...
  for($i = 0;$i< $_SESSION['contador'];$i++){
    ...
    echo '<class="center-all-contens"><center><br><h2>El pedido se ha realizado con éxito<h2><center>';
  }else{
    echo '<class="center-all-contens"><center><br><h2>No has seleccionado ningún producto, revisa el carrito de compras<h2><center>';
  }

}else{
    echo '<class="center-all-contens"><center><br><h2>El nombre o contraseña invalidos<h2></center>';
}
